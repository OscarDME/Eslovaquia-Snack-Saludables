// lib/copy.js — todo el copy visible de la landing. Eslovaco, verbatim desde
// loncherafeliz.aprende-hoy.shop. Akékoľvek zmeny textu sa robia tu.
...
export const copy = {
  ...
  hero: {
    ...
    ctaLabel: "Kúpiť teraz a ušetriť 95 %!",
    trustChips: [
    ...
    items: [
      {
        ...
        quote:
          "Nikdy by som neverila, že môj syn začne tak rýchlo jesť zdravé desiate! Recepty sú nielen veľmi jednoduché, ale mu aj neskutočne chutia. Ďakujem, že ste mi uľahčili život! Najlepšia investícia, akú som kedy urobila.",
      },
      {
        initial: "M",
        name: "Martin",
      ...
      },
      {
        ...
        quote:
          "Ako odborníčka môžem potvrdiť, že tieto recepty sú ideálne vyvážené. Moje deti ich zbožňujú a ja som pokojná, pretože viem, že jedia kvalitne. Vrelo odporúčam každému rodičovi!",
      },
      {
        initial: "K",
        name: "Katarína",
        ...
        quote:
          "Kvôli nabitému programu som nemala vôbec čas na varenie. Táto kniha zmenila všetko: recepty za 15 minút, ktoré si moje deti pýtajú znova a znova. Stojí za každý cent! Už som ju odporučila všetkým svojim kamarátkam.",
      },
    ],
  },
  ...
  whatYouGet: {
    ...
    items: [
      "500 rýchlych a výživných receptov na raňajky, obedy, večere a desiate do školy",
      "Hotové týždenné jedálničky + zoznamy cenovo dostupných nákupov",
      "Nápady na dokonalé kombinovanie raňajok, desiat a večerí",
    ...
    items: [
      {
        ...
        desc: "Pripravte si zdravé verzie ich obľúbených jedál, bez pridaného cukru, bez lepku a hotové doslova za pár minút.",
      },
      {
        value: "19.99 €",
        title: "Praktický sprievodca organizáciou a mrazením jedál (Meal Prep)",
      ...
      {
        value: "14.99 €",
        title: "Zdravé a ľahko pripraviteľné čerstvé šťavy a smoothies",
        desc: "Praktické recepty na prírodné, výživné a chutné šťavy, ktoré osviežia deň vašich najbližších.",
      },
    ],
  ...
  exclusiveBonuses: {
    ...
    items: [
      {
        value: "18.99 €",
        title: "Domáce ovocné gumené cukríky s vysokým obsahom vitamínu C",
        desc: "Naučte sa vyrábať prírodné gumené cukríky bohaté na vitamín C, čím posilníte imunitný systém svojich detí zábavným a chutným spôsobom. Bez pridaného cukru, 100 % prírodné a plné živín!",
      },
      {
        value: "19.99 €",
        title: "Ako naučiť deti zamilovať si zeleninu",
        desc: "Premeňte zeleninu na chutné a zábavné dobrodružstvo pre vaše deti. Jednoduché recepty, vďaka ktorým budú jesť zeleninu s obrovskou radosťou.",
      },
      {
        value: "17.99 €",
        title: "Sprievodca rýchlymi desiatami pre vyberavých jedlíkov",
        desc: "Objavte jednoduché a výživné desiate, ideálne pre deti so slabým apetítom, ktoré im pomôžu stravovať sa zdravo a veľmi chutne.",
      },
      {
        value: "17.99 €",
        title: "Sprievodca superpotravinami pre deti",
        desc: "Naučte sa, ako pomocou jednoduchých receptov plných dôležitých živín zaradiť do jedálnička superpotraviny, ktoré zlepšia zdravie a energiu vašich detí.",
      },
    ],
  ...
  finalCta: {
    ...
    button: "Kúpiť teraz a ušetriť 95 %!",
    ...
    imageAlt:
      "Kompletný balíček: E-kniha Zdravé detské desiate + 9 bonusov",
  ...
  guarantee: {
    ...
    body: "Sme si takí istí, že si tohto sprievodcu zamilujete, že vám ponúkame bezpodmienečnú 14-dňovú záruku. Ak z akéhokoľvek dôvodu nebudete na 100 % spokojní, vrátime vám každý cent. Bez zbytočných otázok a komplikácií.",
    footer: "✅ Garantované plné vrátenie peňazí • ✅ Bez zbytočných otázok • ✅ Okamžité vybavenie",
  },
    ...
    items: [
      {
        ...
        a: "Sprievodca je určený predovšetkým pre deti od 2 do 12 rokov, hoci recepty sa dajú ľahko prispôsobiť úplne pre všetky vekové kategórie.",
      },
      {
        q: "Je vhodný pre deti s alergiami?",
        a: "Áno! Ponúkame recepty prispôsobené najčastejším alergiám, ako sú mlieko, vajcia, sója a arašidy, takže všetky deti si môžu užiť chutné a zdravé jedlo.",
      },
      {
        q: "Musím vedieť dobre variť?",
        a: "Nie, recepty sú navrhnuté tak, aby boli maximálne jednoduché na prípravu, s malým počtom surovín a nenáročnými krokmi. Aj keď nie ste expert v kuchyni, zvládnete to na jednotku!",
      },
      {
        q: "Sú suroviny drahé?",
        a: "Nie, všetky suroviny sú cenovo dostupné a ľahko ich nájdete v každom bežnom supermarkete. Nepotrebujete žiadne drahé alebo ťažko dostupné produkty.",
      },
      {
        q: "Ako dlho trvá príprava desiat?",
        a: "Recepty sú mimoriadne rýchle, pričom väčšina jedál je hotová za menej ako 15 minút.",
      },
      {
        q: "Môžem platiť vo svojej lokálnej mene?",
        a: "Áno! Náš platobný systém automaticky prepočíta sumu podľa kurzu vašej lokálnej meny. Pri prechode k platbe uvidíte cenu upravenú pre vašu menu, takže sa nemusíte obávať žiadnych dodatočných poplatkov za prevod. Garantujeme, že proces platby je jednoduchý a úplne transparentný, bez ohľadu na to, kde sa nachádzate.",
      },
    ],
  },
  ...
  closing: {
    ...
    headline:
      "Nepremeškajte túto jedinečnú príležitosť premeniť stravovanie vašej rodiny!",
    subheadline:
      "Kompletný sprievodca + 9 bonusov v hodnote 167.91 € AKO DARČEK! To všetko za cenu jednej večere v reštaurácii",
    regularPrice: "201.00 €",
    offerPrice: "8.90 €",
    ctaLabel: "ÁNO, CHCEM SVOJU PRÍRUČKU HNEĎ TERAZ!",
    trustRow:
      "🔒 100 % bezpečná platba • ⚡ Okamžitý prístup • ✅ 14-dňová záruka vrátenia peňazí bez rizika",
  },
