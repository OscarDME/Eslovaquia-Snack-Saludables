...
export const copy = {
  ...
  hero: {
    ...
    starsAriaLabel: "5 hviezdiÄiek",
    socialProof: "+5 000 spokojnÃ½ch rodÃ­n",
    trustChips: [
  ...
  exclusiveBonuses: {
    ...
    items: [
      {
        value: "18.99 €",
        title: "Domáce ovocné želé cukríky s vysokým obsahom vitamínu C",
        desc: "Naučte sa vyrábať prírodné želé cukríky bohaté na vitamín C, čím posilníte imunitný systém svojich detí zábavným a chutným spôsobom. Bez pridaného cukru, 100 % prírodné a plné živín!",
      },
      {
        value: "19.99 €",
